...
$appointments = $appointment->obtenerCitasPorMes($currentMonth, $currentYear);
...
<head>
    ...
    <title>Calendario de Citas - Sistema de Citas Médicas</title>
            ...
            modalBody.innerHTML = `
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-3">${appointment.doctor_nombre} ${appointment.doctor_apellido}</p>
