...
try {
    ...
    if (empty($eventos)) {
        ...
        echo '<p class="text-muted">Este paciente no tiene registros médicos o citas programadas.</p>';
        echo '</div>';
        exit;
    }
    ...
    echo '<p class="text-muted mb-0">Timeline cronológico de todos los registros médicos y citas.</p>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
