...
if($_POST && isset($_POST['action'])) {
    switch($_POST['action']) {
        case 'create_patient':
            ...
            if($patient_id) {
                $message = 'Paciente agregado exitosamente a tu lista de pacientes.';
            } else {
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Puedes agregar pacientes directamente o aparecerán aquí una vez que tengan citas contigo.</p>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <strong>Nota:</strong> Este paciente será agregado al sistema. Podrás crear citas y gestionar su historial médico.
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
