...
// Obtener historial médico del paciente (solo registros del doctor actual o todos si es admin)
if($_SESSION['user_type'] == 'administrador') {
    $stmt = $medicalHistory->obtenerPorPaciente($patient_id);
} else {
    // Para doctores, mostrar solo sus registros y todos los registros del paciente
    ...
    $stmt->bindParam(':paciente_id', $patient_id);
    $stmt->execute();
}
?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($history['doctor_id'] == $_SESSION['user_id']): ?>
                                                <br><span class="badge bg-primary">Tu registro</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <?php if($_SESSION['user_id'] == $history['doctor_id']): ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($cot['doctor_id'] == $_SESSION['user_id']): ?>
